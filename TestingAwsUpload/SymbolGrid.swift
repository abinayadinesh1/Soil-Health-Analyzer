...
//        @State private var selectedSymbol: Symbol?
    @State private var selectedImage: CoverImage?
...
//        ]
    ...
    func addSymbol() {
        selectedImage = CoverImage(name: "new", cover: Image(uiImage: inputImage))
        guard let newImage = selectedImage else { return }
        withAnimation {
            symbols.insert(newImage, at: 0)
        }
    }
    var body: some View {
        VStack {
...
//    }
//
//    //this is not getting added properly
//    func addSymbol() {
